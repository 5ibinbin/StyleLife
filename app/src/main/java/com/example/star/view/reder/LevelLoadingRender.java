...
/**
 * Created by：Cral-Gates on 16/9/18 22:12
...
import com.example.star.utils.common.DisplayUtils;


public class LevelLoadingRender extends LoadingRender {
    ...
    private LevelLoadingRender(Context context) {
        super(context);
        init(context);
        setupPaint();
    ...
    private void init(Context context) {
        mStrokeWidth = DisplayUtils.dip2px(context, DEFAULT_STROKE_WIDTH);
        mCenterRadius = DisplayUtils.dip2px(context, DEFAULT_CENTER_RADIUS);
    ...
    public static class Builder {
        ...
        public LevelLoadingRender build() {
            LevelLoadingRender loadingRenderer = new LevelLoadingRender(mContext);
